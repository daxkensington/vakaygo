      ...
      <div className="mx-auto max-w-7xl px-6">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-12">
          ...
          <div>
            ...
            <ul className="space-y-6 text-sm text-cream-300">
              ...
              <li><a href="/services" className="flex items-center h-12 hover:text-gold-400 transition-colors">Services</a></li>
              <li><a href="/for-businesses" className="flex items-center h-12 hover:text-gold-400 transition-colors">For Businesses</a></li>
              <li><a href="/for-restaurants" className="flex items-center h-12 hover:text-gold-400 transition-colors">For Restaurants</a></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-6 text-sm text-cream-300">
              ...
              <li><a href="mailto:hello@vakaygo.com" className="flex items-center h-12 hover:text-gold-400 transition-colors">Contact</a></li>
            </ul>
          </div>
        </div>
        ...
        <div className="mt-12 pt-8 border-t border-navy-600">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-6 gap-x-6 gap-y-6 text-sm text-cream-300">
            ...
            <a href="/things-to-do-in-st-lucia" className="flex items-center h-12 hover:text-gold-400 transition-colors">Things to Do in St. Lucia</a>
            <a href="/things-to-do-in-bahamas" className="flex items-center h-12 hover:text-gold-400 transition-colors">Things to Do in Bahamas</a>
            <a href="/things-to-do-in-aruba" className="flex items-center h-12 hover:text-gold-400 transition-colors">Things to Do in Aruba</a>
            <a href="/best-restaurants-grenada" className="flex items-center h-12 hover:text-gold-400 transition-colors">Best Restaurants in Grenada</a>
            <a href="/best-restaurants-barbados" className="flex items-center h-12 hover:text-gold-400 transition-colors">Best Restaurants in Barbados</a>
            <a href="/best-restaurants-jamaica" className="flex items-center h-12 hover:text-gold-400 transition-colors">Best Restaurants in Jamaica</a>
            <a href="/best-hotels-grenada" className="flex items-center h-12 hover:text-gold-400 transition-colors">Best Hotels in Grenada</a>
            <a href="/best-hotels-barbados" className="flex items-center h-12 hover:text-gold-400 transition-colors">Best Hotels in Barbados</a>
            <a href="/best-hotels-jamaica" className="flex items-center h-12 hover:text-gold-400 transition-colors">Best Hotels in Jamaica</a>
          </div>
        </div>
